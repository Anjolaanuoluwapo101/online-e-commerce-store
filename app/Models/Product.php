...
class Product extends Model
{
    ...
    public function getAll($limit = null, $offset = 0, $orderBy = 'created_at', $direction = 'DESC')
    {
        ...
        $allowedColumns = ['id', 'productname', 'brand', 'price', 'quantity', 'upvotes', 'created_at'];
        ...
        // Safely handle LIMIT/OFFSET (cast to int to avoid injection and avoid PDO placeholder issues)
        if ($limit !== null) {
            $limit = (int)$limit;
            $offset = (int)$offset;
