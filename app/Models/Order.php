...
class Order extends Model
{
    ...
    public function create($email, $totalAmount, $cartData = null, $address = null)
    {
        ...
        $sql = "INSERT INTO orders(email, address, total_amount, cart_data) VALUES(:email, :address, :total_amount, :cart_data) RETURNING id";
        $stmt = $this->db->prepare($sql);
        $stmt->execute(['email' => $email, 'address' => $address, 'total_amount' => $totalAmount, 'cart_data' => $cartData]);
