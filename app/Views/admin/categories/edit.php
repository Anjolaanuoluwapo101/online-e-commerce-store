    ...
    <div class="col-md-12">
                ...
                <div class="card-admin-body">
                    <form method="POST" action="/admin/categories/<?= $category['id'] ?>/update">
                        <div class="mb-3">
                            ...
                            <?php endif; ?>
                            <input type="text" id="name" name="name" value="<?= htmlspecialchars($category['name']) ?>" class="form-control" required>
                        </div>
        ...
        <?php else: ?>
            <div class="alert alert-info">
                <p>Category not found or an error occurred while loading the category.</p>
