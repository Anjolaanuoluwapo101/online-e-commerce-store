                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Leave empty to keep the current image. JPG and PNG only, max 5MB.</div>
                                    <div id="imagePreview" class="mt-2" style="display: none;">
                                        <img id="previewImg" src="" alt="Preview" style="width: 150px; height: 150px; object-fit: cover;" class="rounded">
                                    </div>
                                </div>
